...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" id="FormData" action="#" onsubmit="return false" method="POST">
            @csrf
            <div>
                <label for="email" class="block text-sm font-medium leading-6 text-gray-900">邮箱地址/用户名</label>
                <div class="mt-2">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="{{ route('forgotpassword') }}"
                           class="font-semibold text-indigo-600 hover:text-indigo-500">忘记密码？</a>
                    </div>
                </div>
                <div class="mt-2">
        ...
        <p class="mt-10 text-center text-sm text-gray-500">
            ...
            <a href="{{ route('register') }}"
               class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">点击注册</a>
        </p>
    </div>
</div>
</body>
